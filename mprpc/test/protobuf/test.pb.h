...
// .fixbug.ResultCode reslut = 1;
inline bool GetFriendListResponse::_internal_has_reslut() const {
  return this != internal_default_instance() && reslut_ != nullptr;
}
inline bool GetFriendListResponse::has_reslut() const {
  return _internal_has_reslut();
}
inline void GetFriendListResponse::clear_reslut() {
  if (GetArenaNoVirtual() == nullptr && reslut_ != nullptr) {
    delete reslut_;
  }
  reslut_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListResponse::_internal_reslut() const {
  const ::fixbug::ResultCode* p = reslut_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListResponse::reslut() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponse.reslut)
  return _internal_reslut();
}
inline ::fixbug::ResultCode* GetFriendListResponse::release_reslut() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListResponse.reslut)
  
  ::fixbug::ResultCode* temp = reslut_;
  reslut_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListResponse::_internal_mutable_reslut() {
...
inline ::fixbug::ResultCode* GetFriendListResponse::mutable_reslut() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.reslut)
  return _internal_mutable_reslut();
}
inline void GetFriendListResponse::set_allocated_reslut(::fixbug::ResultCode* reslut) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete reslut_;
  }
  ...
  reslut_ = reslut;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListResponse.reslut)
}
